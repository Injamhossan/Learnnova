            ...
            <div className="space-y-5">
                ...
                <div className="grid grid-cols-2 gap-4">
                    <form action={handleGoogleSignIn}>
                        <button type="submit" className="flex w-full items-center justify-center gap-2 py-2.5 px-4 border border-slate-200 rounded-xl hover:bg-slate-50 transition-colors text-sm font-medium text-slate-700">
                    ...
                    <button type="button" className="flex w-full items-center justify-center gap-2 py-2.5 px-4 border border-slate-200 rounded-xl hover:bg-slate-50 transition-colors text-sm font-medium text-slate-700">
                ...
                <form className="space-y-4">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <label htmlFor="remember" className="text-sm text-slate-600 select-none font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">
